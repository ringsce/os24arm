...
typedef int (*blkdev_read_fn)(blkdev_t *dev, uint64_t sector, uint32_t count, void *buf);
typedef int (*blkdev_write_fn)(blkdev_t *dev, uint64_t sector, uint32_t count, const void *buf);
...
struct blkdev {
    ...
    /* Device geometry */
    uint64_t start_sector;        /* First sector (for partitions) */
 ...
 */
static inline int blk_read(blkdev_t *dev, uint64_t sector, uint32_t count, void *buf)
{
 ...
 */
static inline int blk_write(blkdev_t *dev, uint64_t sector, uint32_t count, const void *buf)
{
